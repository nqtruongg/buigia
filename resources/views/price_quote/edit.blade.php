...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.price_quote.edit'),
        'middle_page' => trans('language.price_quote.title'),
        'current_page' => trans('language.price_quote.edit'),
    ])
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered" id="table_service">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center align-middle w-40">
                                ...
                                <div class="row pt-4">
                                    <div class="col-12 d-flex  justify-content-end" style="font-size: 20px">
                                        ...
                                        <span
                                            class="sum-price">{{ old('total_hidden') ? number_format(old('total_hidden')) : number_format($sum) }}<span>đ</span></span>
                                        <input type="hidden" name="total_hidden" value="{{old('total_hidden') ?? '0' }}">
                                    </div>
                                </div>
                            </div>
