                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        @if (auth()->user()->department->type == 'manager')
                                            {{ \App\Models\CommissionBonus::sum('price') ?? 0 }}đ
                                    </div>
                                @else
                                    {{ \App\Models\CommissionBonus::where('user_id', auth()->user()->id)->sum('price') ?? 0 }}đ
                                </div>
                                @endif
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input name="from" type="text" placeholder="{{ trans('language.started_at') }}"
                                value="{{ request()->from ?? '' }}" class="datepicker_start form-control form-control-sm">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
