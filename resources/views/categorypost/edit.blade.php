            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <form id="form_submit" action="{{ route('categoryPost.update', ['id' => $categoryPostById->id]) }}" method="post"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <img id="img"
                                                 ...
                                                 src="{{ asset($categoryPostById->image_path) }}"
                                                 alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            Có <input type="radio" name="hot" value="1" {{ $categoryPostById->hot === 1 ? 'checked' : '' }}>
                                            không <input type="radio" name="hot" value="0" {{ $categoryPostById->hot === 0 ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <br>
                                            Hiện <input type="radio" name="active" value="1" {{ $categoryPostById->active === 1 ? 'checked' : '' }}>
                                            ẩn <input type="radio" name="active" value="0" {{ $categoryPostById->active === 0 ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                      ...
                                                      cols="40" rows="10" name="description">{{ old('description') ?? $categoryPostById->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control"
                                                      ...
                                                      cols="40" rows="10" name="content">{{ old('content') ?? $categoryPostById->content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="parent_id">
                                                ...
                                                @foreach($listCategoryPost as $category)
                                                    <option {{ $category->id == $categoryPostById->parent_id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->name }}</option>
