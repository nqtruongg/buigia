...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.payment.title'),
        'current_page' => trans('language.payment.title'),
    ])
    ...
    <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('payment.export') }}" type="button" class="btn btn-primary mr-2">
                            <i class="fas fa-plus"></i>{{ trans('language.export') }}</a>
                        <a href="{{ route('payment.create') }}" type="button" class="btn btn-info">
                            <i class="fas fa-plus"></i>{{ trans('language.payment.add') }}</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="collapse {{ optional(request())->hasAny(['name', 'from', 'to']) ? 'show' : '' }}"
                            id="collapseExample">
                                    ...
                                    <div class="col-md-12 d-flex">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>{{ trans('language.payment.name') }}</label>
                                                <input type="text" class="form-control form-control-sm" name="name"
                                                    value="{{ request()->name ?? '' }}"
                                                    placeholder="{{ trans('language.payment.name') }}">
                                            </div>
                                        </div>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('language.payment.name') }}</th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="flex justify-center items-center">
                                                        <a class="flex items-center mr-3" style="color:#28a745"
                                                            target="blank"
                                                            href="{{ route('payment.printf', ['id' => $item->id]) }}">
                                                        ...
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            data-id="{{ $item->id }}"
                                                            data-title="{{ trans('message.confirm_delete_payment') }}"
                                                            data-text="<span >{{ $item->name }}</span>"
                                                            data-url="{{ route('payment.delete', ['id' => $item->id]) }}"
