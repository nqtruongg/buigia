...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.payment.add'),
        'middle_page' => trans('language.payment.title'),
        'current_page' => trans('language.payment.add'),
    ])
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <form id="form_submit" action="{{ route('payment.store') }}" method="post"
