    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="collapse {{ optional(request())->hasAny(['name', 'last_name', 'phone', 'first_name', 'customer_service', 'date']) ? 'show' : '' }}"
                            id="collapseExample">
                            <form action="{{ route('commission.commissionBonus') }}" method="get">
                                <div class="card-header">
                                    <div class="col-md-12 d-flex">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>{{ trans('language.user.first_name') }}</label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>{{ trans('language.user.last_name') }}</label>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>{{ trans('language.commission.phone') }}</label>
                                                <input type="text" class="form-control form-control-sm" name="phone"
                                                    value="{{ request()->phone ?? '' }}"
                                                    placeholder="{{ trans('language.commission.phone') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>{{ trans('language.commission.customer_service') }}</label>
                                                <input type="text" class="form-control form-control-sm" name="service"
                                                    value="{{ request()->service ?? '' }}"
                                                    placeholder="{{ trans('language.commission.customer_service') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 d-flex">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>{{ trans('language.commission.date') }}</label>
                                                <input type="date" class="form-control form-control-sm" name="date"
                                                       value="{{ request()->date ?? '' }}"
                                                       placeholder="{{ trans('language.commission.date') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="">
                                            <div class="form-group d-flex flex-column">
                                                <label>&nbsp;</label>
                                                <a href="{{ route('commission.commissionBonus') }}"
