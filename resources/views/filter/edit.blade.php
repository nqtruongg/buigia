...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.filter.edit'),
        'middle_page' => trans('language.filter.title'),
        'current_page' => trans('language.filter.edit'),
    ])

    @php
        $infoTabHasErrors = $errors->has('name');
        $infoTabHasErrors = $errors->has('filter_type_id');
        $infoTabHasErrors = $errors->has('exact_value');
        $infoTabHasErrors = $errors->has('min_value');
        $infoTabHasErrors = $errors->has('max_value');
        $infoTabHasErrors = $errors->has('direction');
    @endphp
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('filter.update', $filter->id) }}" method="post" enctype="multipart/form-data" id="form-filter">
                        @csrf
                                                        ...
                                                        <label>{{ trans('language.filter.filter_type_id') }}<span
                                                                ...
                                                                <select class="form-control" name="filter_type_id">
                                                                    ...
                                                                    @foreach($filterTypes as $category)
                                                                        <option value="{{ $category->id }}" @if ($filter->filter_type_id == $category->id)
                                                                            selected
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="exact_value"
                                                            value="{{ old('exact_value') ?? $filter->exact_value }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="min_value"
                                                            value="{{ old('min_value') ?? $filter->min_value }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="max_value"
                                                            value="{{ old('max_value') ?? $filter->max_value }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="direction"
                                                            value="{{ old('direction') ?? $filter->direction }}"
