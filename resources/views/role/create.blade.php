            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <form id="form_submit" action="{{ route('role.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <div class="d-flex justify-content-between">
                                                @foreach ($permissions as $permission)
                                                    <div class="info-box bg-light ml-3 mr-3">
                                                        <div class="">
                                                            <input name="permission_id[]" type="checkbox" class=" checkboxRole"
                                                            value="{{ $permission->id }}">
                                                        {!! \App\Models\Permission::checkTypePermission($permission->type) !!}
                                                        </div>
                                                    </div>
                                            ...
                                            <ul
                                                ...
                                                @foreach ($permissions as $permission)
                                                    <li>
                                                        <div class="mailbox-attachment-info d-flex align-items-center justify-content-center" style="background-color: #cccccc">
                                                            <input name="permission_id[]" type="checkbox"
                                                                class=" checkboxRole mr-2" value="{{ $permission->id }}">
                                                            {!! \App\Models\Permission::checkTypePermission($permission->type) !!}
                                                        </div>
                                                    </li>
                                                @endforeach
