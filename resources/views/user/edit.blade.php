...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.user.edit'),
        'middle_page' => trans('language.user.title'),
        'current_page' => trans('language.user.edit'),
    ])
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <form id="form_submit" action="{{ route('user.update', ['id' => $user->id]) }}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="department_id" id="department_id">
                                                ...
                                                @php
                                                    $choose_brand = old('department_id') ? old('department_id') : (isset($user->department_id) ? $user->department_id : '');
                                                @endphp
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="role_id" name="role_id">
                                                <option selected="selected">Vai trò</option>
                                            </select>
