...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.receivable.edit'),
        'middle_page' => trans('language.receivable.title'),
        'current_page' => trans('language.receivable.edit'),
    ])
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <form id="form_submit" action="{{ route('receivable.update', ['id' => $receivable->id]) }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{ trans('language.receivable.contract_value') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control input-price" name="" disabled
