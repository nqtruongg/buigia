...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.receivable.extend'),
        'middle_page' => trans('language.receivable.title'),
        'current_page' => trans('language.receivable.extend'),
    ])
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form id="form_submit" action="{{ route('receivable.storeExtend') }}" method="post"
                                            ...
                                            <div class="tab-pane fade {{ $i == 0 ? 'show active' : '' }}"
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label>{{trans('language.receivable.ended_at')}}
...
@section('js')
    ...
    <script src="{{ asset('/dist/js/pages/create_receivable_extend.js') }}"></script>
@endsection
