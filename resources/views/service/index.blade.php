...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.service.title'),
        'current_page' => trans('language.service.title'),
    ])
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="{{ route('service.create') }}" type="button" class="btn btn-info">
                            <i class="fas fa-plus"></i>{{ trans('language.service.add') }}</a>
                    </div>
                </div>
            </div>
        </div>
