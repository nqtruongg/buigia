...
@section('css')
    <style>
        ...
        .file-input-wrapper .btnRemoveEditAjax {
            position: absolute;
            top: -7px;
            right: 3px;
            font-size: 17px;
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <form id="form_submit" action="{{ route('service.update', ['id' => $service->id]) }}"
                              method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <img id="img" src="{{ $service->image_path }}"
                                                 style="{{ !empty($service->image_path) ? 'with: 200px; height: 200px; object-fit: cover' : '' }}"
                                                 alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <img id="img_banner_path" src="{{ $service->banner_path }}"
                                                 style="{{ !empty($service->banner_path) ? 'with: 200px; height: 200px; object-fit: cover' : '' }}"
                                                 alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mt-3 mb-3">
                                    ...
                                    <div style="border: 1px solid #272727; padding: 20px 0 0 18px; border-radius: 5px;">
                                        <div id="variantContainer" class="d-flex flex-wrap">
                                            @if(!empty($service->serviceImages) && count($service->serviceImages) > 0)
                                                ...
                                                @foreach ($service->serviceImages as $image)
                                                    <div class="variantColor d-flex align-items-center">
                                                        <div class="mb-3 w-25 file-input-wrapper"
                                                            ...
                                                            <img src="{{ asset('storage/services/' . basename($image->related_photo)) }}"
                                                                 alt="Preview Image" style="display: inline;">
                                                            <button class="btnRemoveEditAjax" type="button"
                                                                    style="display: flex;"
                                                                    data-url="{{ route('service.destroyImage', $image->id) }}"
                                                                    data-method="DELETE"
                                                                    data-id="{{ $image->id }}">×
                                                            </button>
                                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" value="{{ old('acreage') ?? $service->acreage }}" name="acreage"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ trans('language.service.numberBedroom') }}<span
                                                    class="text-danger">*</span></label><br>
                                            <input type="number" class="form-control" value="{{ old('numberBedroom') ?? $service->numberBedroom }}" name="numberBedroom"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ trans('language.service.toilet') }}<span
                                                    class="text-danger">*</span></label><br>
                                            <input type="number" class="form-control" value="{{ old('toilet') ?? $service->toilet }}" name="toilet"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ trans('language.service.direction') }}<span
                                                    class="text-danger">*</span></label><br>
                                            <input type="text" class="form-control" value="{{ old('direction') ?? $service->direction }}" name="direction"
                                        ...
                                        <select name="category_id[]" multiple class="form-control select2" id="categoryService">
                                            ...
                                            @if(!empty($listCategoryService))
                                                @foreach ($listCategoryService as $category)
                                                    <option @if (in_array($category->id, $selectedCategoryIds)) selected @endif value="{{ $category->id }}">{{ $category->name }}</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ trans('language.service.hot') }}<span
                                                    class="text-danger">*</span></label><br>
                                            Có <input type="radio" name="hot" value="1" {{ $service->hot === 1 ? 'checked' : '' }}>
                                            không <input type="radio" name="hot" value="0" {{ $service->hot === 0 ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{ trans('language.service.active') }}<span
                                                    class="text-danger">*</span></label>
                                            <br>
                                            Hiện <input type="radio" name="active" value="1" {{ $service->active === 1 ? 'checked' : '' }}>
                                            ẩn <input type="radio" name="active" value="0" {{ $service->active === 0 ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                </div>
