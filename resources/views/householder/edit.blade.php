...
@section('content')
    @include('partials.breadcrumb', [
        'title' => trans('language.householder.edit'),
        'middle_page' => trans('language.householder.title'),
        'current_page' => trans('language.householder.edit'),
    ])
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('householder.update', ['id' => $houseHolder->id]) }}" method="post"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="name"
                                                            value="{{ old('name') ?? $houseHolder->name }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="description"
                                                            value="{{ old('description') ?? $houseHolder->description }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="tax_code"
                                                            value="{{ old('tax_code') ?? $houseHolder->tax_code }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="address"
                                                            value="{{ old('address') ?? $houseHolder->address }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="invoice_address"
                                                            value="{{ old('invoice_address') ?? $houseHolder->invoice_address }}"
